    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div v-if="visible">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Derivadas Visitadora Social
            ...
            <div v-else>
                ...
                <h1 class="text-center">Visitadora Social | Entrevista Alumna</h1>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
       ...
       /*  props: ['ruta'], */
        ...
        methods:{
            ...
            ocultarDetalle(id){
                ...
                axios.post( '/det_visitadora/registrar',{
            ...
            listarDetalleOrientadora(page){
                ...
                url =  '/det_visitadora?page=' + page;
                 axios.get(url).then(function (response) {
                     var respuesta = response.data;
                     me.arrayDetalle = respuesta.det_visitadoras.data;
                     me.pagination = respuesta.pagination;
                })
                .catch(function (error) {
                    console.log(error);
