<template>
 ...
 <div v-else>
                ...
                <div class="form-group row ">
                    <div class="form-group col-7 form-inline border">
                        <label for="" class="form-label-group"><h5>Nombre :</h5> </label>
                        <h6 for="" v-text="' '+nombres+' '+apellidos"></h6>
                    </div>
                    <div class="form-group col-2 form-inline border">
                    ...
                    <div class="form-group col-3 form-inline border">
                        <label for="" class="form-label-group"><h5>Fecha Der. :</h5> </label>
                        <h6 for="" v-text="antecedentes"></h6>
                    </div>
                </div>
                                            ...
                                            <table class="table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                    <tr v-for="orientadora in arrayOrientadora" :key="orientadora.id">
                                                        <template v-if="!orientadora.visible">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="psicologa in arrayPsicologa" :key="psicologa.id">
                                                        <template v-if="!psicologa.visible">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="visitadora in arrayVisitadora" :key="visitadora.id">
                                                        <template v-if="!visitadora.visible">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="convivencia in arrayConvivencia" :key="convivencia.id">
                                                        <template v-if="!convivencia.visible">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="terapeuta in arrayTerapeuta" :key="terapeuta.id">
                                                        <template v-if="!terapeuta.visible">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="educadora in arrayEducadora" :key="educadora.id">
                                                        <template v-if="!educadora.visible">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            pdfReporte(id){
               /*  window.open(':8000/reporte/reportePdf/'+ id + ',' + '_blank'); */
                    ...
                    case "alumna":
                    {
                        switch(accion){
                            case 'actualizar':
                            {
                                ...
                                this.FechaDerivacion= data['created_at'];
