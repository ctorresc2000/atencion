    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div v-if="visible">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Derivadas Convivencia Escolar
            ...
            <div v-else>
                ...
                <h1 class="text-center">Convivencia Escolar | Entrevista Alumna</h1>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
    ...
    export default {
        ...
        methods:{
            ...
            ocultarDetalle(id){
                ...
                axios.post( '/det_convivencia/registrar',{
            ...
            listarDetalleOrientadora(page){
                ...
                url =  '/det_convivencia?page=' + page;
                 axios.get(url).then(function (response) {
                     var respuesta = response.data;
                     me.arrayDetalle = respuesta.det_convivencias.data;
                     me.pagination = respuesta.pagination;
                })
                .catch(function (error) {
                    console.log(error);
