    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div v-if="visible">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Derivadas Orientadora
            ...
            <div v-else>
                ...
                <h1 class="text-center">Orientadora | Entrevista Alumna</h1>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
                <label for=""></label>
        ...
        methods:{
            ...
            listarDetalleOrientadora(page){
                ...
                url = '/det_orientadora?page=' + page;
                 axios.get(url).then(function (response) {
                     var respuesta = response.data;
                     me.arrayDetalle = respuesta.det_orientadoras.data;
                     me.pagination = respuesta.pagination;
                })
                .catch(function (error) {
                    console.log(error);
