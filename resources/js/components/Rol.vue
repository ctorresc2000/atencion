                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                               <!--  <select class="form-control col-md-3" v-model="criterio">
                                ...
                                <!-- <input type="text" v-model="buscar" @keyup.enter="listarRol(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar (Rut sin digito)">
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="roles in arrayRol" :key="roles.id">
                                ...
                                <div v-else>
                                    <span class="badge badge-danger">Ianctivo</span>
                                </div>
                            </tr>
                        </tbody>
                    </table>
    ...
    export default {
        ...
        methods:{            
            listarRol(page,buscar,criterio){
                let me=this;
                url = '/rol?page=' + page + '&buscar='+buscar+'&criterio='+criterio;
